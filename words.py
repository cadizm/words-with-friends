...
table = lookupify(os.path.abspath(os.path.join(os.path.dirname(__file__), 'enable1.txt')))
...
if __name__ == '__main__':
  ...
  for w in reversed(sorted(find_words(letters, blanks), key=lambda x: (len(x), x))):
    print(len(w), w)
